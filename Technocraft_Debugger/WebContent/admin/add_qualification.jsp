            ...
            <div class="panel-body">
              ...
              <form class="cmxform" id="signupForm" method="post" action="<%= request.getContextPath() %>/Add_qualification_controller">
                ...
                <div class="form-group">
                  ...
                  <input id="qualification_name" name="qualification_name" type="text" class="form-control" placeholder="Qualification Name" required />
                </div>
				
                <div class="form-group">
                  <label for="qualification_desc">Qualification Description</label>
                  <textarea id="qualification_desc" name="qualification_desc" class="form-control" required ></textarea>
                </div>
