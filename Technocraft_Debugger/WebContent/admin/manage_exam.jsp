        ...
        <div class="col-md-12">
          <div class="panel panel-visible">
            <div class="panel-heading">
              <div class="panel-title"> <i class="fa fa-table"></i>Manage Exam</div>
            </div>
            <div class="panel-body">
              ...
              <table class="table table-striped table-bordered table-hover" id="datatable">
                <thead>
                  <tr>
                    <th>Exam Id</th>
                    <th class="hidden-xs">Exam Name</th>
                ...
                <a:forEach items="${sessionScope.list }" var="i">
                  <tr>
                    <td><% out.print(j); j++; %></td>
                    <td class="hidden-xs"><span class="xedit">${i.exam_name }</span></td>
                    <td class="hidden-xs hidden-sm"><span class="xedit">${i.exam_desc}</span></td>
                    
                    <td class="hidden-xs text-center">
                    	<div class="btn-group">
                        	<!-- <button type="button" class="btn btn-info btn-gradient"> <span class="glyphicons glyphicons-cogwheels"></span> </button> -->
                        	<button type="button" class="btn btn-success btn-gradient" onclick="fn('<%=request.getContextPath() %>/Add_exam_controller?flag=edit&user=Admin&id=${i.exam_id}')"> <span class="glyphicons glyphicons-cogwheels"></span> </button>
                        	<button type="button" class="btn btn-danger btn-gradient dropdown-toggle" data-toggle="dropdown" onclick="fn('<%= request.getContextPath()%>/Add_exam_controller?flag=delete&user=Admin&id=${i.exam_id}')"> <span class="glyphicons glyphicons-bin"></span> </button>
                        	  ...
                        	  <li><a href="<%=request.getContextPath()%>/Add_exam_controller?flag=activestatus&id=${i.exam_id}"><i class="fa fa-user"></i> Active </a></li>
                        	  <li><a href="<%=request.getContextPath()%>/Add_exam_controller?flag=deactivestatus&id=${i.exam_id}"><i class="fa fa-envelope-o"></i> Deactive </a></li>
                       	 	</ul>
                      	</div>
                    
                    	<%-- <a href="<%=request.getContextPath() %>/Add_exam_controller?flag=edit&id=${i.exam_id}">Edit</a>/<a href="<%= request.getContextPath()%>/Add_exam_controller?flag=delete&id=${i.exam_id}">Delete</a> --%>
                   </td>
                  </tr>
                 </a:forEach>
                </tbody>
