...
<div id="main">
  <div class="container">
    <div class="row">
      ...
      <div id="page-logo"> <img src="<%=request.getContextPath()%>/User/images/mylogo.png" class="img-responsive" alt="logo"> </div>
    </div>
    <div class="row">
      <div class="panel">
          ...
          <div class="panel-footer"> <span class="panel-title-sm pull-left" style="padding-top: 7px;"><a href="<%= request.getContextPath() %>/Company/forgotpassword.jsp">Forgotten Password?</a></span>
            <div class="form-group margin-bottom-none">
								...
								<input class="btn btn-primary pull-right" type="submit"
									value="Login" /> <input type="hidden" name="login" value="true">
