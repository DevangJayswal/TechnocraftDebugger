        ...
        <div class="col-md-12 col-lg-6 col-lg-offset-3">
          <div class="panel">
            <div class="panel-heading">
              <div class="panel-title"> <i class="fa fa-pencil"></i>Add Sub Category</div>
            </div>
            <div class="panel-body">
              <div class="alert alert-info"></div>
              <form class="cmxform" id="signupForm" method="post" action="<%= request.getContextPath() %>/Add_sub_cat_controller">
			 <a:forEach items="${sessionScope.list}" var="a">
                <div class="form-group">
					<label for="Select Category">Select Category</label>
					<select name="cat" class="form-control">
						<a:forEach items="${sessionScope.list1 }" var="j">
							<a:if test="${a.c.cat_id==j.cat_id }">
                ...
                <div class="form-group">
                  ...
                  <input id="sub_cat_name" name="sub_cat_name" value="${a.sub_cat_name }" type="text" class="form-control" placeholder="Sub Category Name" required />
                </div>
				
                <div class="form-group">
                  <label for="sub_cat_desc">Sub Category Description</label>
                  <textarea id="sub_cat_desc" name="sub_cat_desc" class="form-control" required >${a.sub_cat_desc }</textarea>
                </div>
				
                <div class="form-group">
                		<input class="submit btn btn-blue" type="submit" value="Edit">
						<input type="hidden" name="flag" value="update">
						<input class="submit btn btn-blue" type="hidden" name="id" value="${a.sub_cat_id}">
                </div>
			</a:forEach>
              </form>
            </div>
