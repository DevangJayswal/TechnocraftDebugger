...
<%@taglib prefix="a" uri="http://java.sun.com/jstl/core_rt" %>
        ...
        <section class="title-section">
            <div class="container">
                ...
                <div class="row crumbs">
                   <div class="col-md-12">
                        <a href="<%=request.getContextPath() %>/User/user_index.jsp">Home</a> / Questions
                   </div>
                </div>
                <!-- End crumbs --> 
        ...
        <section class="paddings">
        	<form action="<%= request.getContextPath()%>/Give_Exam_Controller" method="post">
            	<div class="container">
                	...
                	<a:set var="examcnt" value="${sessionScope.examcnt}" scope="session" ></a:set>
                		<a:forEach items="${sessionScope.searchque}" var="que" varStatus="i">
                			<a:if test="${examcnt eq i.count}">
                				<input type="hidden" name="Question" value="${que.question_id}"/>
                				<div class="accordion-trigger"><i class="fa fa-android"></i>Questions ${examcnt}</div>
                				<div class="accordion-container1">       
                    				<p>${que.question}</p>
                    				
                    				<input readonly="readonly" type="radio" name="ans" value='${que.ans1}'>${que.ans1}<br>
                    				<input readonly="readonly" type="radio" name="ans" value='${que.ans2}'>${que.ans2}<br>
                    				<input readonly="readonly" type="radio" name="ans" value='${que.ans3}'>${que.ans3}<br>
                    				<input readonly="readonly" type="radio" name="ans" value='${que.ans4}'>${que.ans4}<br>
                				</div>
                	...
                	<a:set var="examcnt" value="${examcnt+1}" scope="session"></a:set>
                	
                	
                	<!-- <div class="accordion-trigger"><i class="fa fa-apple"></i>Questions 2</div >   -->   
                	
                	<div class="accordion-container1">
						<input type="hidden" name="result" value="${marks}" readonly="readonly"/>
                	</div>
                	
                	<div class="accordion-container1">       
                    	<input type="hidden" name="flag" value="result"/>
