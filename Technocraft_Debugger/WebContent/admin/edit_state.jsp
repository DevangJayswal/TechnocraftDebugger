            ...
            <div class="panel-body">
			  ...
			  <a:forEach items="${sessionScope.list}" var="a">
               	<div class="form-group">
					...
					<select name="country" class="form-control">
						<a:forEach items="${sessionScope.list1 }" var="j">
							<a:if test="${a.s.country_id==j.country_id }">
                ...
                <div class="form-group">
                  ...
                  <input id="state_name" name="state_name" value="${a.state_name }" type="text" class="form-control" placeholder="State Name" required />
                </div>
				
                <div class="form-group">
                  <label for="state_desc">State Description</label>
                  <textarea id="state_desc" name="state_desc" class="form-control" required >${a.state_desc }</textarea>
                </div>

                <div class="form-group">
                		<input class="submit btn btn-blue" type="submit" value="Edit">
						<input type="hidden" name="flag" value="update">
						<input class="submit btn btn-blue" type="hidden" name="id" value="${a.state_id}">
                </div>
			</a:forEach>
              </form>
            </div>
