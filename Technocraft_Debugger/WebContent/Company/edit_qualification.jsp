        ...
        <div class="col-md-12 col-lg-6 col-lg-offset-3">
          <div class="panel">
            <div class="panel-heading">
              <div class="panel-title"> <i class="fa fa-pencil"></i>Add Qualification</div>
            </div>
            <div class="panel-body">
              <div class="alert alert-info"></div>
              <form class="cmxform" id="signupForm" method="post" action="<%= request.getContextPath() %>/Add_qualification_controller">
			  
               <a:forEach items="${sessionScope.list}" var="i">
				
                <div class="form-group">
                  <label for="qualification_name">Qualification Name</label>
                  <input id="qualification_name" value="${i.qualification_name }" name="qualification_name" type="text" class="form-control" placeholder="Qualification Name" required />
                </div>
				
                <div class="form-group">
                  <label for="qualification_desc">Qualification Description</label>
                  <textarea id="qualification_desc" name="qualification_desc" class="form-control" required >${i.qualification_desc}</textarea>
                </div>
                ...
                <div class="form-group">
						...
						<input class="submit btn btn-blue" type="hidden" name="id" value="${i.qualification_id}">
                </div>
			</a:forEach>
              </form>
            </div>
