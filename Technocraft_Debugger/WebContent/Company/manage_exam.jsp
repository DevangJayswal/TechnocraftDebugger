                  ...
                  <tr>
                    ...
                    <td class="hidden-xs text-center">
                    	<div class="btn-group">
                        	...
                        	<button type="button" class="btn btn-success btn-gradient" onclick="fn('<%=request.getContextPath() %>/Add_exam_controller?flag=edit&user=company&id=${i.exam_id}')"> <span class="glyphicons glyphicons-cogwheels"></span> </button>
                        	<button type="button" class="btn btn-danger btn-gradient dropdown-toggle" data-toggle="dropdown" onclick="fn('<%= request.getContextPath()%>/Add_exam_controller?flag=delete&user=company&id=${i.exam_id}')"> <span class="glyphicons glyphicons-bin"></span> </button>
