       ...
       <!-- Title Section -->           
        <section class="title-section">
            <div class="container">
                ...
                <div class="row crumbs">
                   <div class="col-md-12">
                        <a href="<%= request.getContextPath()%>/User/user_index.jsp">Home</a> / Our Services
                   </div>
                </div>
                <!-- End crumbs --> 
        ...
        <section class="paddings services">
            <div class="container">
                  ...
                  <div class="col-md-4">
                      <div class="item-service border-right">
                          <div class="row head-service">
                              ...
                              <div class="col-md-10">
                             	  <h4>Job Title : ${list.job_title}</h4>
                                  <h5>Job Description : ${list.job_description}</h5>
                                  <h4>Job Skills : ${list.job_skills}</h4>
                                  <h5>Job Salary : ${list.job_salary}</h5>
                                  <h4>Job Address : ${list.job_address}</h4>
                                  <h5>Company Name : ${list.company_name}</h5>
                                  <h4>Company Email : ${list.comapny_email}</h4>
                                  <h5>Reference Name : ${list.ref_name}</h5>
                                  <h4>Reference Number : ${list.ref_number}</h4>
                                  <h5>10% : ${list.ten_per}</h5>
                                  <h4>12% : ${list.twelve_per}</h4>
                                  <h5>Graduation% : ${list.graduation}</h5>
                                  <h4>Application Date : ${list.app_date}</h4>
                                  <h5>Interview Date : ${list.inter_date}</h5>
              ...
              <div class="row">
                 <!-- Item service-->
                 <a:forEach items="${sessionScope.exam_detail}" var="list">
                  <div class="col-md-4">
                      <div class="item-service border-right">
                          <div class="row head-service">
                              <div class="col-md-2">
                              ...
                              <div class="col-md-10">
                                  <h4>${list.exam_name}</h4>
                                  <h5>${list.exam_desc}</h5>
                                  <h4>${list.exam_date}</h4>
                                  <h5>${list.exam_time}</h5>
                                  <h4>${list.total_marks}</h4>
                                  <h5>${list.pass_marks}</h5>
                              </div>
                          </div>                          
