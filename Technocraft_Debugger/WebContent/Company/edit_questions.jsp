			  ...
			  <a:forEach items="${sessionScope.list}" var="a">
				...
				<div class="form-group">
					...
					<select name="Exam" class="form-control">
						<a:forEach items="${sessionScope.list3 }" var="l">
						<a:if test="${a.v3.exam_id==l.exam_id }">
							<option value="${l.exam_id }" selected="selected">${l.exam_name }</option>
						</a:if>
						<a:if test="${a.v3.exam_id!=l.exam_id }">
							<option value="${l.exam_id }">${l.exam_name }</option>
						</a:if>
						</a:forEach>
					</select>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input id="question" value="${a.question}" name="question" type="text" class="form-control" placeholder="Question" required />
                </div>
				
				<div class="form-group">
                  <label for="ans1">Answer 1</label>
                  <input id="ans1" value="${a.ans1}" name="ans1" type="text" class="form-control" placeholder="Answer 1" required />
                </div>
				
				<div class="form-group">
                  <label for="ans2">Answer 2</label>
                  <input id="ans2" name="ans2" value="${a.ans2}" type="text" class="form-control" placeholder="Answer 2" required />
                </div>
				
				<div class="form-group">
                  <label for="ans3">Answer 3</label>
                  <input id="ans3" value="${a.ans3}" name="ans3" type="text" class="form-control" placeholder="Answer 3" required />
                </div>
				
				<div class="form-group">
                  <label for="ans4">Answer 4</label>
                  <input id="ans4" value="${a.ans4}" name="ans4" type="text" class="form-control" placeholder="Answer 4" required />
                </div>
				
				<div class="form-group">
                  <label for="correct_ans">Correct Answer</label>
                  <input id="correct_ans" value="${a.correct_ans}" name="correct_ans" type="text" class="form-control" placeholder="Correct Answer" required />
                </div>

				<div class="form-group">
                  <label for="question_marks">Question Marks</label>
                  <input id="question_marks" value="${a.question_marks}" name="question_marks" type="text" class="form-control" placeholder="Question Marks" required />
                </div>
				
				<label for="question_marks">Upload Your File</label>
				<div class="form-group">
                ...
                <div class="form-group">
						...
						<input class="submit btn btn-blue" type="hidden" name="id" value="${a.question_id}">
                </div>
			</a:forEach>
              </form>
            </div>
