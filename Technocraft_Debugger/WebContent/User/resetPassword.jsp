...
<%@taglib prefix="a" uri="http://java.sun.com/jstl/core_rt" %>
  <head>
    ...
    <meta charset="utf-8">
    <title>Technocraft Debuger  | Reset Password</title> 
       ...
       <%@ include file="header.jsp" %>
        ...
        <section class="title-section">
            <div class="container">
                ...
                <div class="row crumbs">
                   <div class="col-md-12">
                        <a href="index.html">Home</a> / <a href="#">Features</a> / <a href="#">Pages </a> / Register User
                   </div>
                </div>
                <!-- End crumbs --> 
        ...
        <section class="paddings">
            <div class="container">
				...
				<a:forEach items="${sessionScope.obj }" var="record">
                    ...
                    <form action="<%= request.getContextPath() %>/User_Reg_Controller" method="post">
                        ...
                        <div class="col-md-10">
                            <div class="row padding_top_mini">
                                ...
                                <div class="col-md-4">
                                    <input placeholder="Username" type="text" name="u_uname"  value="${record.user_name}" readonly>
                                </div>
						...
						<div class="col-md-12">
                    		...
                    		<input type="hidden" name="u_email" value="${record.u_email}"/>
