        ...
        <div class="col-md-12">
          <div class="panel panel-visible">
            <div class="panel-heading">
              <div class="panel-title"> <i class="fa fa-table"></i>Manage User</div>
            </div>
            <div class="panel-body">
              <table class="table table-striped table-bordered table-hover" id="datatable">
                ...
                <tbody>
                <% int j=1;%>
                <a:forEach items="${sessionScope.cregi}" var="i">
                  <tr>
                    <td><% out.print(j); j++; %></td>
                    <td class="hidden-xs"><span class="xedit">${i.c_name}</span></td>
                    <td class="hidden-xs hidden-sm"><span class="xedit">${i.c_email}</span></td>
                    <td class="hidden-xs hidden-sm"><span class="xedit">${i.user_id.status}</span></td>
                    <%-- <td class="hidden-xs hidden-sm"><span class="xedit">${i.u_email}</span></td> --%>
                    <td class="hidden-xs text-center">
                    	<div class="btn-group">
                        	<!-- <button type="button" class="btn btn-info btn-gradient"> <span class="glyphicons glyphicons-cogwheels"></span> </button> -->
                        	<%-- <button type="button" class="btn btn-success btn-gradient" onclick="fn('<%=request.getContextPath() %>/Company_Reg_Controller?flag=edit&id=${i.c_id}')"> <span class="glyphicons glyphicons-cogwheels"></span> </button> --%>
                        	<button type="button" class="btn btn-success btn-gradient dropdown-toggle" data-toggle="dropdown"> <span class="glyphicons glyphicons-cogwheels"></span></button>
                        	  ...
                        	  <li><a href="<%=request.getContextPath()%>/Company_Reg_Controller?flag=activestatus&id=${i.user_id.user_id}"><i class="fa fa-user"></i> Active </a></li>
                        	  <li><a href="<%=request.getContextPath()%>/Company_Reg_Controller?flag=deactivestatus&id=${i.user_id.user_id}"><i class="fa fa-envelope-o"></i> Deactive </a></li>
                       	 	</ul>
                      </div>
                    </td>
                  </tr>
