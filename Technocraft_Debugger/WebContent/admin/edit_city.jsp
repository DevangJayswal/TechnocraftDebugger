        ...
        <div class="col-md-12 col-lg-6 col-lg-offset-3">
          <div class="panel">
            <div class="panel-heading">
              <div class="panel-title"> <i class="fa fa-pencil"></i>Add Sub City</div>
            </div>
            <div class="panel-body">
              <div class="alert alert-info"></div>
              
              <form class="cmxform" id="signupForm" action="<%= request.getContextPath() %>/Add_city_controller" method="post">
				<a:forEach items="${sessionScope.list}" var="a"> 
					...
					<select name="Country" class="form-control">
						<a:forEach items="${sessionScope.list2}" var="j">
							<a:if test="${a.v2.country_id==j.country_id }">
				...
				<div class="form-group">
					...
					<select name="State" class="form-control">
						<a:forEach items="${sessionScope.list1}" var="k">
							<a:if test="${a.v3.state_id==k.state_id }" >
								<option value="${k.state_id }" selected="selected">${k.state_name }</option>
							</a:if>
							<a:if test="${a.v3.state_id!=k.state_id }">
                ...
                <div class="form-group">
                  ...
                  <input id="city_name" name="city_name" value="${a.city_name}" type="text" class="form-control" placeholder="City Name" required />
                </div>
				
                <div class="form-group">
                  <label for="city_desc">City Description</label>
                  <textarea id="city_desc" name="city_desc" class="form-control" required >${a.city_desc }</textarea>
                </div>
				
                <div class="form-group">
                		<input class="submit btn btn-blue" type="submit" value="Edit">
						<input type="hidden" name="flag" value="update">
						<input class="submit btn btn-blue" type="hidden" name="id" value="${a.city_id}">
                </div>
				</a:forEach>
              </form>
