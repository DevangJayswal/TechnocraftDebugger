            ...
            <div class="panel-body">
              ...
              <form class="cmxform" id="signupForm" action="<%= request.getContextPath() %>/Add_cat_controller" method="post">
                ...
                <div class="form-group">
                  ...
                  <input id="cat_name" name="cat_name" type="text" class="form-control" value="${i.cat_name}" placeholder="Category Name" required />
                </div>
				
                <div class="form-group">
                  <label for="cat_desc">Category Description</label>
                  <textarea id="cat_desc" name="cat_desc" class="form-control" required>${i.cat_desc}</textarea>
                </div>

                <div class="form-group">
              		  	<input class="submit btn btn-blue" type="submit" value="Edit">
						<input type="hidden" name="flag" value="update">
						<input class="submit btn btn-blue" type="hidden" name="id" value="${i.cat_id}">
                </div>
				</a:forEach>
              </form>
            </div>
