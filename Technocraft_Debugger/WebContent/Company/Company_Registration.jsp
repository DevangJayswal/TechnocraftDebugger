                    ...
                    <div class="tab-content border-none">
                      <div class="tab-pane" id="tab1">
                        ...
                        <div class="form-group">
                          <div class="input-group"> <span class="input-group-addon"><i class="glyphicons glyphicons-building"></i> </span>
                            <input class="form-control" type="text" name="c_name" placeholder="Company Name" required>
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="input-group"> <span class="input-group-addon"><i class="glyphicons glyphicons-envelope"></i> </span>
                            <input class="form-control" type="email" name="c_email" placeholder="Company Email" required>
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="input-group"> <span class="input-group-addon"><i class="glyphicons glyphicons-phone"></i> </span>
                            <input class="form-control" type="text" name="c_number" placeholder="Contact Number" required>
                          </div>
                        </div>
                        <!-- <div class="form-group">
                        ...
                        <div class="form-group">
                          <div class="input-group"> <span class="input-group-addon"><i class="glyphicons glyphicons-road"></i> </span>
                            <input class="form-control" type="text" name="c_address" placeholder="Company Address" required>
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="input-group"> <span class="input-group-addon"><i class="fa fa-globe"></i> </span>
                            <input class="form-control" type="text" name="c_web_address" placeholder="Company Web Address" required>
                          </div>
                        </div>
                      </div>
                      <div class="tab-pane" id="tab2">
                        ...
                        <div class="form-group">
							...
							<select name="country" class="form-control">
								<a:forEach items="${sessionScope.cntry}" var="j">
                        ...
                        <div class="form-group">
							...
							<select name="state" class="form-control">
								<a:forEach items="${sessionScope.state}" var="k">
									<option value="${k.state_id}">${k.state_name }</option>
								</a:forEach>
							</select>
                		</div>
						<div class="form-group">
							...
							<select name="city" class="form-control">
								<a:forEach items="${sessionScope.city}" var="l">
                		...
                		<div class="form-group">
                          <div class="input-group"> <span class="input-group-addon"><i class="glyphicons glyphicons-pin"></i> </span>
                            <input class="form-control" type="text" name="c_pincode" placeholder="Pin Code" required>
                          </div>
                        </div>
                      </div>
                      <div class="tab-pane" id="tab3">
                        ...
                        <div class="form-group">
                          <div class="input-group"> <span class="input-group-addon"><i class="glyphicons glyphicons-user"></i> </span>
                            <input class="form-control" type="text" name="c_username" placeholder="User Name" required>
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="input-group"> <span class="input-group-addon"><i class="fa fa-key"></i> </span>
                            <input class="form-control" type="password" name="c_pass" placeholder="Password" required>
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="input-group"> <span class="input-group-addon"><i class="fa fa-key"></i> </span>
                      ...
                      <div class="tab-pane" id="tab4">
                      	<div class="input-file">
                        	<iframe class="form-control100" src="image_upload.jsp" style="height:200px; width:100%"> </iframe>
