        ...
        <div class="col-md-12">
          <div class="panel panel-visible">
            <div class="panel-heading">
              <div class="panel-title"> <i class="fa fa-table"></i>Manage Package</div>
            </div>
            <div class="panel-body">
              <table class="table table-striped table-bordered table-hover" id="datatable">
                <thead>
                  <tr>
                    <th>Package Id</th>
                    <th class="hidden-xs">Package Name</th>
                ...
                <a:forEach items="${sessionScope.list }" var="i">
                  <tr>
                    <td><% out.print(j); j++; %></td>
                    <td class="hidden-xs"><span class="xedit">${i.pack_name }</span></td>
                    <td class="hidden-xs hidden-sm"><span class="xedit">${i.pack_desc}</span></td>
                    
                    <td class="hidden-xs text-center">
                    	<div class="btn-group">
                        	<!-- <button type="button" class="btn btn-info btn-gradient"> <span class="glyphicons glyphicons-cogwheels"></span> </button> -->
                        	<button type="button" class="btn btn-success btn-gradient" onclick="fn('<%=request.getContextPath() %>/Add_package_controller?flag=edit&id=${i.pack_id}')"> <span class="glyphicons glyphicons-cogwheels"></span> </button>
                        	<button type="button" class="btn btn-danger btn-gradient dropdown-toggle" data-toggle="dropdown" onclick="fn('<%= request.getContextPath()%>/Add_package_controller?flag=delete&id=${i.pack_id}')"> <span class="glyphicons glyphicons-bin"></span> </button>
                      	...
                      	<%-- <a href="<%=request.getContextPath() %>/Add_package_controller?flag=edit&id=${i.pack_id}">Edit</a>/<a href="<%= request.getContextPath()%>/Add_package_controller?flag=delete&id=${i.pack_id}">Delete</a> --%>
                     </td>
                  </tr>
                 </a:forEach> 
                </tbody>
