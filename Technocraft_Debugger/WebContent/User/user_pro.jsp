    ...
    <div id="layout">
      ...
      <!-- End Login Client -->
       ...
       <%@ include file="header.jsp" %>
        ...
        <a:forEach items="${sessionScope.user_list}" var="user">
            <div class="container">
            ${user.u_uname}
            ${user.u_email}
                 ...
                 <div class="row register padding-top-mini">
                    <form action="<%= request.getContextPath() %>/User_Reg_Controller" method="post">
                        ...
                        <div class="col-md-10">
                            <div class="row">
                                <div class="col-md-4">
                                    <input placeholder="Your Name" type="text" value="${user.u_uname}" name="u_name" required>
                                </div>
                                <div class="col-md-4">
                                    <input placeholder="Your Email" type="email" value="${user.u_emmail}" name="u_email" required>
                                </div>
                            </div>
 						</div>
