            ...
            <div class="panel-body">
              ...
              <form class="cmxform" id="signupForm" method="post"  action="<%= request.getContextPath() %>/Add_job_controller">
                ...
                <div class="form-group">
                  ...
                  <input id="job_skills" name="job_skills" type="text" class="form-control" placeholder="Skills" required />
                </div>
                <div class="form-group">
                  <label for="salary">Salary</label>
                  <!-- <input id="salary" name="job_salary" type="text" class="form-control" placeholder="Salary" required/> -->
                        <div class="input-group"> <span class="input-group-addon"><i class="fa fa-usd"></i> </span>
                          <input type="text" name="job_salary" id="maskedMoney" class="form-control money" maxlength="10" autocomplete="off" placeholder="salary" required/> 
 	              	 	</div>
				</div>	
				<div class="form-group">
                  <label for="Address">Address</label>
                  <textarea id="address" name="job_address" class="form-control" required ></textarea>
				</div>
				...
				<div class="form-group">
                  ...
                  <!-- <input id="comapany_email" name="company_email" type="email" class="form-control" placeholder="Email ID" required/> -->
                  <div class="input-group"> <span class="input-group-addon"><i class="fa fa-envelope-o"></i> </span>
                    <input type="text" name="company_email" class="form-control product" autocomplete="off" placeholder="Email Address">
                  </div>
                </div>
				
				<div class="form-group">
                  <label for="ref_name">Reference Name</label>
                  <input id="ref_name" name="ref_name" type="text" class="form-control" placeholder="Reference Name" required/>
                </div>

				<div class="form-group">
                  <label for="ref_num">Reference Number</label>
                  <!-- <input id="ref_num" name="ref_number" type="tel" class="form-control" placeholder="Reference Number" pattern="[0-9]{10,10}" autocomplete="off"  maxlength="10" required/> -->
                  		<div class="input-group"> <span class="input-group-addon"><i class="fa fa-phone"></i> </span>
                        	 <input type="text" name="ref_number" id="maskedPhone" class="form-control phone" maxlength="10" autocomplete="off" placeholder="(999) 999-9999">
                        </div>
                </div>
				
				<div class="form-group">
					  <label for="ten_per">Percentage Obtained in 10th.</label>
					  <input id="ten_per" name="ten_per" type="text" class="form-control" placeholder="10 %" required/>
				</div>
				
				<div class="form-group">
					  <label for="twelve_per">Percentage Obtained in 12th. </label>
					  <input id="twelve_per" name="twelve_per" type="text" class="form-control" placeholder="12 %" required/>
				</div>

				<div class="form-group">
					  <label for="graduation">Percentage Obtained in Graduation</label>
					  <input id="graduation" name="graduation" type="text" class="form-control" placeholder="Graduation %" required/>
				</div>

				<div class="form-group">
					  <label for="app_date">Application Date</label>
					  <!-- <input id="app_date" name="app_date" type="date" class="form-control" placeholder="Application Date" required/> -->
					  	<div class="input-group"> <span class="input-group-addon"><i class="fa fa-calendar "></i> </span>
                          <input type="text" name="app_date" id="datepicker_2" class="form-control margin-top-none" placeholder="10/25/2013 - 10/25/2013" required />
                        </div>
				</div>
				<div class="form-group">
					  <label for="inter_date">Interview Date</label>
					  <!-- <input id="inter_date" name="inter_date" type="date" class="form-control" placeholder="Interview Date" required/> -->
					  <div class="input-group"> <span class="input-group-addon"><i class="fa fa-calendar "></i> </span>
                          <input type="text" name="inter_date" id="datepicker_2" class="form-control margin-top-none" placeholder="10/25/2013 - 10/25/2013" required />
                      </div>
				</div>
				
				<div class="form-group">
                  <label for="pass_marks">Job Status</label>
                  <label>
