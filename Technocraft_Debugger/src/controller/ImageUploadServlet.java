...
public class ImageUploadServlet extends HttpServlet {
      ...
      // Check that we have a file upload request
	   ...
	   String path1= filePath.substring(0, path) +"\\User\\doc\\";
      ...
      String path2= filePath.substring(0, path) +"\\User\\temp\\";
      ...
      {
    	  response.sendRedirect(request.getContextPath()+"/User/image_upload.jsp");
      }
      else
      {
    	  response.sendRedirect(request.getContextPath()+"/Company/image_upload.jsp");
      }
   }catch(Exception ex) {
