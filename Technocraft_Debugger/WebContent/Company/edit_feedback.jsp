        ...
        <div class="col-md-6 col-lg-5 col-lg-offset-1">
          <div class="panel">
            <div class="panel-heading">
              <div class="panel-title"> <i class="fa fa-pencil"></i>Give Feedback</div>
            </div>
            <div class="panel-body">
              <div class="alert alert-info"></div>
              <form class="cmxform" id="signupForm" method="post" action="<%= request.getContextPath() %>/Add_feedback_controller">
              
			  	<a:forEach items="${sessionScope.list}" var="i">
			  	
                <div class="form-group">
                  <label for="fb_username">Username</label>
                  <input id="fb_username" name="fb_username" value="${i.fb_username }" type="text" class="form-control" placeholder="Username" required />
                </div>
				
				 <div class="form-group">
                  <label for="fb_msg">Message</label>
                  <textarea id="fb_msg" name="fb_msg" class="form-control" required >${i.fb_msg }</textarea>
                </div>
				
                <div class="form-group">
                		<input class="submit btn btn-blue" type="submit" value="Edit">
						<input type="hidden" name="flag" value="update">
						<input class="submit btn btn-blue" type="hidden" name="id" value="${i.fb_id}">
                </div>
