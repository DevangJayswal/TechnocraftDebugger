        ...
        <div class="col-md-12 col-lg-6 col-lg-offset-3">
          <div class="panel">
            <div class="panel-heading">
              <div class="panel-title"> <i class="fa fa-pencil"></i>Add Country</div>
            </div>
            <div class="panel-body">
              <div class="alert alert-info"></div>
              <form class="cmxform" id="signupForm" method="post" action="<%= request.getContextPath()%>/Add_country_controller">
			  	
			  	<a:forEach items="${sessionScope.list}" var="i">
			  	  	
                <div class="form-group">
                  <label for="country_name">Country Name</label>
                  <input id="country_name" name="country_name" value="${i.country_name}" type="text" class="form-control" placeholder="Country Name" required />
                </div>
				
                <div class="form-group">
                  <label for="country_desc">Country Description</label>
                  <textarea id="country_desc" name="country_desc" class="form-control" required >${i.country_desc}</textarea>
                </div>
				
                <div class="form-group">
                  		<input class="submit btn btn-blue" type="submit" value="Edit">
						<input type="hidden" name="flag" value="update">
						<input class="submit btn btn-blue" type="hidden" name="id" value="${i.country_id}">
                </div>
				</a:forEach>
              </form>
            </div>
