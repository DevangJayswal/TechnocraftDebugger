...
<head>
    <meta charset="utf-8">
    <title>Tecnocraft Debuger | Exam List</title> 
        ...
        <section class="title-section">
            <div class="container">
                ...
                <div class="row crumbs">
                   <div class="col-md-12">
                        <a href="<%= request.getContextPath()%>/User/user_index.jsp">Home</a> / Exam List
                   </div>
                </div>
                <!-- End crumbs --> 
            ...
            <div class="container">
              ...
              <div class="row padding-top">
                 <!-- Item service-->
                  ...
                  <a:forEach items="${sessionScope.exam_list}" var="list">
                  	<a:if test="${list.exam_status eq '1'}">
                  <div class="col-md-4">
                      <div class="item-service border-right">
                          <div class="row head-service">
                              ...
                              <div class="col-md-10">
                             	  <h3><a href="<%=request.getContextPath() %>/Exam_Detail_Controller?flag=exam_detail&id=${list.exam_id}">Exam_Name : ${list.exam_name}</a></h3>
                                  <h4>Exam Description : ${list.exam_desc}</h4>                              
                              </div>
                     	  </div>                          
                      </div>
                  </div>
