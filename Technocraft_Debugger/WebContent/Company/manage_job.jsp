              ...
              <table class="table table-striped table-bordered table-hover" id="datatable">
                ...
                <a:forEach items="${sessionScope.list5}" var="i">
                  <tr>
                    ...
                    <td class="hidden-xs hidden-sm"><span class="xedit">${i.job_description}</span></td>
                    
                    <td class="hidden-xs text-center">
                    	<div class="btn-group">
                        	<!-- <button type="button" class="btn btn-info btn-gradient"> <span class="glyphicons glyphicons-cogwheels"></span> </button> -->
                        	<button type="button" class="btn btn-success btn-gradient" onclick="fn('<%=request.getContextPath() %>/Add_job_controller?flag=edit&user=company&id=${i.job_id}')"> <span class="glyphicons glyphicons-cogwheels"></span> </button>
                        	<button type="button" class="btn btn-danger btn-gradient dropdown-toggle" data-toggle="dropdown" onclick="fn('<%= request.getContextPath()%>/Add_job_controller?flag=delete&user=company&id=${i.job_id}')"> <span class="glyphicons glyphicons-bin"></span> </button>
