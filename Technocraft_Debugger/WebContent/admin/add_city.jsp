        ...
        <div class="col-md-12 col-lg-6 col-lg-offset-3">
          <div class="panel">
            <div class="panel-heading">
              <div class="panel-title"> <i class="fa fa-pencil"></i>Add City</div>
            </div>
            <div class="panel-body">
              ...
              <form class="cmxform" id="signupForm" action="<%= request.getContextPath() %>/Add_city_controller" method="post">
                ...
                <div class="form-group">
                  ...
                  <input id="city_name" name="city_name" type="text" class="form-control" placeholder="City Name" required />
                </div>
				
                <div class="form-group">
                  <label for="city_desc">City Description</label>
                  <textarea id="city_desc" name="city_desc" class="form-control" required ></textarea>
                </div>
