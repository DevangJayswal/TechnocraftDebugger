            ...
            <div class="panel-body">
              ...
              <form class="cmxform" id="signupForm" method="post" action="<%= request.getContextPath() %>/Add_sub_cat_controller">
                ...
                <div class="form-group">
                  ...
                  <input id="sub_cat_name" name="sub_cat_name" type="text" class="form-control" placeholder="Sub Category Name" required />
                </div>
				
                <div class="form-group">
                  <label for="sub_cat_desc">Sub Category Description</label>
                  <textarea id="sub_cat_desc" name="sub_cat_desc" class="form-control" required ></textarea>
                </div>
