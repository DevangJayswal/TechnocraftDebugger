            ...
            <div class="panel-body">
              ...
              <form class="cmxform" id="signupForm" method="post" action="<%= request.getContextPath() %>/Add_feedback_controller">
                ...
                <div class="form-group">
                  ...
                  <input id="fb_username" name="fb_username" type="text" class="form-control" placeholder="Username" required />
                </div>
				
				 <div class="form-group">
                  <label for="fb_msg">Message</label>
                  <textarea id="fb_msg" name="fb_msg" class="form-control" required ></textarea>
                </div>
