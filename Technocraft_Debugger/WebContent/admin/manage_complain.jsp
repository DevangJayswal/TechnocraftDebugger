        ...
        <div class="col-md-12">
          <div class="panel panel-visible">
            <div class="panel-heading">
              <div class="panel-title"> <i class="fa fa-table"></i>Manage Complain</div>
            </div>
            <div class="panel-body">
              <table class="table table-striped table-bordered table-hover" id="datatable">
                ...
                <tbody>
                  <tr>
                    <td><span class="xedit">Admin</span></td>
                    <td class="hidden-xs"><span class="xedit">Administrator</span></td>
                    <td class="hidden-xs hidden-sm"><span class="xedit">admin@gmail.com</span></td>
