            ...
            <div class="panel-body">
              ...
              <form class="cmxform" id="signupForm" method="post" action="<%= request.getContextPath() %>/Add_package_controller">
                ...
                <div class="form-group">
					...
					<input id="pack_" name="pack_type" type="text" class="form-control" placeholder="Pack Type" required />
				</div>

                <div class="form-group">
                  <label for="pack_name">Pack Name</label>
                  <input id="pack_name" name="pack_name" type="text" class="form-control" placeholder="Pack Name" required />
                </div>
				
                <div class="form-group">
                  <label for="pack_desc">Package Description</label>
                  <textarea id="pack_desc" name="pack_desc" class="form-control" required ></textarea>
                </div>
				
				<div class="form-group">
                  <label for="pack_price">Package Price</label>
                  <!-- <input id="pack_price" name="pack_price" type="text" class="form-control" placeholder="Package Price" required /> -->
                  		<div class="input-group"> <span class="input-group-addon"><i class="fa fa-usd"></i> </span>
                          <input type="text" name="pack_price" id="maskedMoney" class="form-control money" maxlength="10" autocomplete="off" placeholder="000.000.000.000" required/> 
 	              	 	</div>
                </div>
				
				<div class="form-group">
                  <label for="pack_val">Package Validity</label>
                  <!-- <input id="pack_val" name="pack_validity" type="text" class="form-control" placeholder="Package Validity" required /> -->
                  		<div class="input-group"> <span class="input-group-addon"><i class="fa fa-calendar"></i> </span>
                        	  <input type="text" name="pack_validity" id="datepicker" class="form-control datepicker margin-top-none" placeholder="23/9/2013">
                        </div>
                </div>
